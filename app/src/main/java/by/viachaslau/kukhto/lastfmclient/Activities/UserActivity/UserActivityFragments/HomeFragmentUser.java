        ...
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            itemHolder.cell.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(TrackActivity.TRACK_URL, resentTracks.get(position));
    ...
    class TopTracksSection extends Section {
        ...
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            itemHolder.cell.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(getContext(), TrackActivity.class);
                    intent.putExtra(TrackActivity.TRACK_URL, topTracks.get(position));
                    startActivity(intent);
                }
            });
        }
    ...
    class LovedTracksSection extends Section {
        ...
        public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            itemHolder.cell.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(getContext(), TrackActivity.class);
                    intent.putExtra(TrackActivity.TRACK_URL, lovedTracks.get(position));
                    startActivity(intent);
                }
            });
        }
