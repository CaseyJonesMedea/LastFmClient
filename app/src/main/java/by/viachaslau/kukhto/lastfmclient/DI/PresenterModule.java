...
import by.viachaslau.kukhto.lastfmclient.UI.List.ListActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.List.ListModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.Search.SearchActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.Search.SearchModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.Track.TrackActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.Track.TrackModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.User.UserActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.User.UserModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.Welcome.WelcomeModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.Welcome.WelcomePresenter;
import by.viachaslau.kukhto.lastfmclient.UI.WorldChard.WorldChartActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.WorldChard.WorldChartModelImpl;
import by.viachaslau.kukhto.lastfmclient.UI.YouTube.YouTubeActivityPresenter;
import by.viachaslau.kukhto.lastfmclient.UI.YouTube.YouTubeModelImpl;
