...
import by.viachaslau.kukhto.llikelastfm.Others.Model.modelApp.HomeFragmentInformation;
...
public class HomeFragmentUser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (homeFragmentInformation.getRecentTracks().size() == 0) {
            recentTracksSection.setState(Section.State.FAILED);
        }
        ...
        if (homeFragmentInformation.getTopArtists().size() == 0) {
            topArtistsSection.setState(Section.State.FAILED);
        }
        ...
        if (homeFragmentInformation.getTopAlbums().size() == 0) {
            topAlbumsSection.setState(Section.State.FAILED);
        }
        ...
        if (homeFragmentInformation.getTopTracks().size() == 0) {
            topTracksSection.setState(Section.State.FAILED);
        }
        ...
        if (homeFragmentInformation.getLovedTracks().size() == 0) {
            lovedTracksSection.setState(Section.State.FAILED);
        }
