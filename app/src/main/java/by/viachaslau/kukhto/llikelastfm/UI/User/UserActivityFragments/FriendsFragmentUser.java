...
public class FriendsFragmentUser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FriendsSection friendsSection = new FriendsSection(R.layout.section_header, R.layout.section_friends, R.layout.section_load_empty, R.layout.section_not_friends);
        friendsSection.setFriends(friendsFragmentInformation.getFriends());
        if (friendsFragmentInformation.getFriends().size() == 0) {
            friendsSection.setState(Section.State.FAILED);
        }
